         ...
         <div class="card">
            ...
            <div class="card-body">
               <table class=".table-striped">
                  ...
                  <tbody>
                     <?php
                        $sql = "SELECT * FROM `member` WHERE `delete_status`=0 AND head_id='".$_GET['id']."'";
                        //print_r($sql);exit;
                        $count=0;
                     ...
                     <tr>
                        ...
                        <td ><a href="familymember_edit.php?id=<?php echo $key['id'];?>"><i class="fa fa-edit" style="font-size:15px; color: blue;"></i></a>
                           <a href="app/membercrud.php?id=<?php echo $key['id'];?>"><i class="fa fa-trash-o" style="font-size:15px; color: red;"></i></a>
                        </td>
                        <?php }?>
                     </tr>
                  </tbody>
